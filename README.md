# Forgemaster Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/forgemaster/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest Forgemaster into src-en/ directory
